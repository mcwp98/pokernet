...
var FOUR_OF_A_KIND = {
    ...
    description: function(cards){
        return 'four of a kind '+Card.pluralRankName(cards[0]);
    }
};
...
var THREE_OF_A_KIND = {
    ...
    description: function(cards){
        return 'three of a kind '+Card.pluralRankName(cards[0]);
    }
};
...
var TWO_PAIR = {
    ...
    description: function(cards){
        return 'two pair '+Card.pluralRankName(cards[0])+' and '+Card.pluralRankName(cards[2]);
    }
};
